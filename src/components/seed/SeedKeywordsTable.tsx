...
import { TrendingUp, ChevronLeft, ChevronRight, Download, Plus, ListPlus } from 'lucide-react';
...
interface SeedKeywordsTableProps {
  keywords: Keyword[];
  totalCount: number;
  currentPage: number;
...
export function SeedKeywordsTable({ 
  keywords = [],
  totalCount = 0,
  currentPage,
  onPageChange,
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className={`w-3 h-3 rounded-full ${
                        keyword.keywordDifficulty <= 30 ? 'bg-green-500' :
                        keyword.keywordDifficulty <= 60 ? 'bg-yellow-500' :
                        'bg-orange-500'
                      }`}></div>
                    </div>
                  </td>
