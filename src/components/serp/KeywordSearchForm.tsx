...
interface KeywordSearchFormProps {
  onSearch: (keyword: string, location: string, language: string, depth: number) => void;
}

export function KeywordSearchForm({ onSearch }: KeywordSearchFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    onSearch(keyword.trim(), location, language, depth);
    setIsLoading(false);
  };
