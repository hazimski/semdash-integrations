...
interface ReferringDomainsFormProps {
  onSearch: (target: string, includeSubdomains: boolean) => void;
}

export function ReferringDomainsForm({ onSearch }: ReferringDomainsFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow space-y-6">
      ...
      >
        ...
        {isLoading ? 'Analyzing...' : 'Analyze Referring Domains'}
      </button>
    </form>
  );
}
