...
interface RankedKeywordsFormProps {
  onSearch: (domain: string, location: string, language: string) => void;
}

export function RankedKeywordsForm({ onSearch }: RankedKeywordsFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    onSearch(domain.trim(), location, language);
    setIsLoading(false);
  };
